          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-forest-text/70 font-body leading-relaxed">
                Comprehensive guides on antenatal care, early pregnancy complications, and maternal medicine. Supporting your clinical education through every trimester.
              </p>
            </div>
            <div className="h-64 rounded-[40px] overflow-hidden shadow-2xl border-4 border-white">
              <img src="https://images.unsplash.com/photo-1531983412531-1f49a365ffed?q=80&w=800&auto=format&fit=crop" alt="Pregnancy" className="w-full h-full object-cover" />
            </div>
          </div>
        </motion.div>
