...
const HistoryAndExamination = () => {
  const categories = [
    {
      title: 'History Taking',
      articles: ['Obstetric History', 'Gynaecological History', 'Sexual History']
    },
    {
      title: 'Examinations',
      articles: ['Obstetric Examination', 'Speculum Examination', 'Bimanual Examination']
    }
  ];
